...
class Model(object):
    def __init__(self, vsize, ctx='cpu'):
        ...
        self.W2 = nd.random_uniform(-.01, .01, shape=(2048, 1024), ctx=self.ctx)
    ...
    def forward(self, x):
        ...
        self.h2 = rnn(self.h1, self.h2, self.W2, self.b2)
        return nd.dot(self.h2, self.Wy) + self.by
    ...
    def reset(self, batchsize):
        ...
        self.h2 = nd.zeros((batchsize, 1024), ctx=self.ctx)